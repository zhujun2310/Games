...
$.fn.make2048 = function (option) {
    var defaultOption = {
        ...
        blocks:[
             ...
             {level: 4, value:32, style:{"background-color":"rgb(244,93,59)", "color":"rgb(255,247,235)", "font-size":50}},
             {level: 5, value:64, style:{"background-color":"rgb(236,205,112)", "color":"rgb(255,247,235)", "font-size":42}},
             {level: 6, value:128, style:{"background-color":"rgb(237,204,97)", "color":"rgb(255,247,235)", "font-size":42}},
             {level: 7, value:256, style:{"background-color":"rgb(236,200,80)", "color":"rgb(255,247,235)", "font-size":34}},
             {level: 8, value:512, style:{"background-color":"rgb(237,197,63)", "color":"rgb(255,247,235)", "font-size":34}},
             {level: 9, value:1024, style:{"background-color":"rgb(238,194,46)", "color":"rgb(255,247,235)", "font-size":34}},
             {level: 10, value:2048, style:{"background-color":"rgb(61,58,51)", "color":"rgb(255,247,235)", "font-size":34}},
   ...
   var getPosition = function (x,y) {
    ...
    var getEmptyBlockIndex = function () {
        ...
        $(state).each(function (index,option) {
            if(option == null) emptyBlockIndexs.push(index);
        });
    ...
    var move =function (direction) {
        var date = new Date();
        if (date - lastMoveTime < option.animateSpeed) return false;//移动时间大于动画时间
        lastMoveTime = date ;
            ...
            for(var y = startY; y <= Math.max(startY,endY) && y >= Math.min(startY,endY);endY > startY ? y++ : y--){
                ...
                if (target_block == null){
                    ...
                    if(updatedBlock.level == option.blocks.length - 1){
                        gameEnd();
                        console.log("gameEnd2");
                    }
                    //console.log(target_block.justModified);
...
/*        switch(direction){
    ...
    var mouseHandler = function (e) {
        if(e.type == "mousedown" && mouseStartPoint == null){
            mouseStartPoint = {x:e.pageX,y:e.pageY};
        }
        if(e.type == "mouseup"){
            var xDistance = e.pageX - mouseStartPoint.x;
            var yDistance = e.pageY - mouseStartPoint.y;
